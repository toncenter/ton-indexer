...
create index if not exists transactions_index_3 on transactions (now asc);
create index if not exists transactions_index_4 on transactions (account, lt asc);
create index if not exists transactions_index_5 on transactions (account, now asc);
...
create index if not exists jetton_transfers_index_9 on jetton_transfers (tx_now asc);
create index if not exists jetton_transfers_index_10 on jetton_transfers (tx_lt asc);

create index if not exists jetton_burns_index_1 on jetton_burns (owner, tx_now asc);
create index if not exists jetton_burns_index_2 on jetton_burns (owner, tx_lt asc);
create index if not exists jetton_burns_index_3 on jetton_burns (jetton_wallet_address, tx_now asc);
create index if not exists jetton_burns_index_4 on jetton_burns (jetton_wallet_address, tx_lt asc);
create index if not exists jetton_burns_index_5 on jetton_burns (jetton_master_address, tx_now asc);
create index if not exists jetton_burns_index_6 on jetton_burns (jetton_master_address, tx_lt asc);
create index if not exists jetton_burns_index_7 on jetton_burns (tx_now asc);
...
create index if not exists nft_transfers_index_1 on nft_transfers (nft_item_address, tx_now asc);
...
create index if not exists nft_transfers_index_6 on nft_transfers (old_owner, tx_now asc);
create index if not exists nft_transfers_index_7 on nft_transfers (new_owner, tx_lt asc);
create index if not exists nft_transfers_index_8 on nft_transfers (new_owner, tx_now asc);
create index if not exists nft_transfers_index_9 on nft_transfers (tx_lt asc);
create index if not exists nft_transfers_index_10 on nft_transfers (tx_now asc);
