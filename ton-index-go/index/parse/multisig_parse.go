...
func ParseOrder(order string) (actions []models.OrderAction, err error) {
	defer func() {
		if r := recover(); r != nil {
...
func parseOrderAction(kv cell.DictKV) (models.OrderAction, error) {
	...
	if orderType == 0xf1381e5b {
		...
		if err != nil {
			...
			parsedBody = &models.UnknownMessage{
				Data: bodyRaw,
			}
		}

		return models.OrderAction{
		...
		if err != nil {
			return models.OrderAction{}, fmt.Errorf("failed to parse multisig update params: %w", err)
		}
		var parsedBody models.ParsedBody = body
		return models.OrderAction{
			ParsedBody:     &parsedBody,
		...
		return models.OrderAction{}, fmt.Errorf("unknown order action type: %d", orderType)
	}

}

// parseMessageBody parses the message body cell and returns the appropriate ParsedBody implementation
func parseMessageBody(bodyCell *cell.Cell) (models.ParsedBody, error) {
	if bodyCell == nil {
...
func parseJettonTransferBodyTlb(slice *cell.Slice) (*models.JettonTransferBody, error) {
...
func parseForwardPayload(payloadSlice *cell.Slice, jt *models.JettonTransferBody) {
	...
	case 0x25938561:
		...
		parseStonfiSwap(payloadSlice, jt)
	default:
		jt.PayloadSumType = "Unknown"
	}
}

func parseStonfiSwap(slice *cell.Slice, jt *models.JettonTransferBody) {
	defer func() {
		if recover() != nil {
			jt.PayloadSumType = "Unknown"
		}
...
func parseJettonBurnBodyTlb(slice *cell.Slice) (*models.JettonBurnBody, error) {
...
func parseJettonMinterBody(slice *cell.Slice, opcode uint32) (*models.JettonMinterBody, error) {
...
func parseNFTTransferBodyTlb(slice *cell.Slice) (*models.NFTTransferBody, error) {
...
func parseEncryptedCommentTlb(slice *cell.Slice) (*models.TonTransferMessage, error) {
	...
	return &models.TonTransferMessage{
		Comment:   snake,
		Encrypted: true,
	}, nil
}

func parseSimpleMessage(slice *cell.Slice) (*models.TonTransferMessage, error) {
	ttm := &models.TonTransferMessage{}
...
func parseJettonTopUpBody(slice *cell.Slice) (*models.JettonTopUpBody, error) {
	...
	return &models.JettonTopUpBody{
		QueryID: tlbStruct.QueryID,
	}, nil
}

func parseJettonChangeAdminBody(slice *cell.Slice) (*models.JettonChangeAdminBody, error) {
	...
	return &models.JettonChangeAdminBody{
		QueryID:      tlbStruct.QueryID,
		NewAdminAddr: formatAddress(tlbStruct.NewAdminAddr),
	}, nil
}

func parseJettonClaimAdminBody(slice *cell.Slice) (*models.JettonClaimAdminBody, error) {
	...
	return &models.JettonClaimAdminBody{
		QueryID: tlbStruct.QueryID,
	}, nil
}

func parseJettonChangeContentBody(slice *cell.Slice) (*models.JettonChangeContentBody, error) {
	_, err := slice.LoadUInt(32)
	if err != nil {
	...
	return &models.JettonChangeContentBody{
		QueryID:        queryId,
		NewMetadataUrl: newMetadataUrl,
	}, nil
}

func parseJettonCallToBody(slice *cell.Slice) (*models.JettonCallToBody, error) {
	...
	return &models.JettonCallToBody{
		QueryID:    tlbStruct.QueryID,
		ToAddress:  formatAddress(tlbStruct.ToAddress),
		TonAmount:  formatCoins(tlbStruct.TonAmount),
...
func parseJettonSetStatusBody(slice *cell.Slice) (*models.JettonSetStatusBody, error) {
	...
	return &models.JettonSetStatusBody{
		QueryID:   tlbStruct.QueryID,
		NewStatus: tlbStruct.NewStatus,
	}, nil
}

func parseSingleNominatorWithdrawBody(slice *cell.Slice) (*models.SingleNominatorWithdrawBody, error) {
	...
	return &models.SingleNominatorWithdrawBody{
		QueryID: tlbStruct.QueryID,
		Coins:   formatCoins(tlbStruct.Coins),
	}, nil
}

func parseSingleNominatorChangeValidatorBody(slice *cell.Slice) (*models.SingleNominatorChangeValidatorBody, error) {
	...
	return &models.SingleNominatorChangeValidatorBody{
		QueryID:          tlbStruct.QueryID,
		ValidatorAddress: formatAddress(tlbStruct.ValidatorAddress),
	}, nil
}

func parseVestingInternalTransferBody(slice *cell.Slice) (*models.VestingInternalTransferBody, error) {
	...
	return &models.VestingInternalTransferBody{
		QueryID:     tlbStruct.QueryID,
...
func parseMultisigUpdateParamsBody(tlbStruct *orderUpdateMultisigParamsActionTlb) (*models.MultisigUpdateParamsBody, error) {
	...
	return &models.MultisigUpdateParamsBody{
...
func parseAddressList(addresses *multisigAddresses) ([]*models.AccountAddress, error) {
	if addresses == nil || addresses.Addresses == nil {
		return nil, nil
	}
	var addressList []*models.AccountAddress
...
func formatAddress(addr *address.Address) *models.AccountAddress {
	if addr == nil {
		return nil
	}
