...
func queryAccountStatesImpl(query string, conn *pgxpool.Conn, settings models.RequestSettings) ([]models.AccountState, error) {
...
func queryAccountStateFullImpl(query string, conn *pgxpool.Conn, settings models.RequestSettings) ([]models.AccountStateFull, error) {
...
func queryTopAccountBalancesImpl(query string, conn *pgxpool.Conn, settings models.RequestSettings) ([]models.AccountBalance, error) {
