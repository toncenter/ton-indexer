...
from tApi.http.models import TonResponse, TonResponseJsonRPC, TonRequestJsonRPC
from tApi.http.exceptions import generic_exception_handler, generic_http_exception_handler
from tApi.tonlib.address_utils import detect_address as __detect_address, prepare_address as _prepare_address
from tApi.tonlib.wallet_utils import wallets as known_wallets, sha256
from tApi.tonlib.utils import TonLibWrongResult
...
async def get_transactions(
    ...
    """
    address = prepare_address(address)
    return await tonlib.getTransactions(address, from_transaction_lt=lt, from_transaction_hash=hash, to_transaction_lt=to_lt, limit=limit, archival=archival)
...
# # TODO: add method getConcensusBlock
