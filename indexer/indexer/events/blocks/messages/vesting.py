...
class VestingSendMessage:
    ...
    message_value: int
    # Hash of the message body cell. Used to check whether the vesting
    # contract actually emitted this message: the contract sends with
    # send mode 3 (+2 = ignore errors), so the send may be silently skipped
    # and no matching outgoing message is produced.
