...
def downgrade():
    ...
    op.create_index('transactions_index_3', 'transactions', ['now'], unique=False)
    op.create_index('transactions_index_2', 'transactions', ['account'], unique=False)
