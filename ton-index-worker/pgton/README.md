...
* tonaddr: acts like a TON address in raw-form string. It accepts `addr_none`, `<workchain>:<64 hex>`, `ext$<length>:<hex data>`, and `var$<workchain>:<length>:<hex data>`. Output hex is uppercase.
