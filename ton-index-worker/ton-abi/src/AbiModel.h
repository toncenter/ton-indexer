...
// { kind: 'nullable'; inner_ty_idx: number; stack_type_id?: number; stack_width?: number }
struct TyNullable {
  int inner_ty_idx = 0;
  std::optional<int> stack_type_id;
  std::optional<int> stack_width;
};
...
// { kind: 'union'; variants: UnionVariant[]; stack_width?: number }
struct TyUnion {
