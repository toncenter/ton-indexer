...
struct TraceProcessorTest : TraceProcessor {
  ...
  TraceProcessorTest(Check check, mch::EmuClassifierConfig config, bool stop_after = true)
      : TraceProcessor(RedisConnectionOptions{}, TraceRetentionConfig{}, std::move(config)),
