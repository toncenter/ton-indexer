...
Measurement &Measurement::print_measurement() {
    td::StringBuilder sb;
    sb << "MEASURE[";
    sb << "id=" << measurement_id << ";";
    sb << "msg_hash_norm=" << b64_hash_or_default(ext_msg_hash_norm_) << ";";
    sb << "msg_hash=" << b64_hash_or_default(ext_msg_hash_) << ";";
    sb << "trace_id=" << b64_hash_or_default(trace_root_tx_hash_) << "]";
